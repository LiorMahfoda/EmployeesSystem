...
void Menu::mainMenu() {
     ...
     while(run) {//while we still want to run:
                ...
                switch(option) {//act accordingly:
                               case ADD_EMPLOYEE: //if we will to add a new employee
                               ...
                               case PRINT_ALL_EMPLOYEES:
                                    printDB();//menu private method that prin the database
                                    break;
                               case PROMOTE_EMPLOYEE:
                                    promoteEmp();//menu private method that promote a given employee
                                    break;
                               case EXIT: run = false; //we wnat to stop running.
...
void Menu::printDB() const {
     const Date today(20,3,2014);//current date - so it can calculate age and working lenght for al the Employess
